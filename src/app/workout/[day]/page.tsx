...
export default function WorkoutPage() {
  ...
  if (isFinished) {
      // Robust average heart rate calculation
      const avgHeartRate = time > 0 ? Math.round((calories / time) * 150) : 75; // simplified but safe calculation
      ...
      const summary = {
          ...
          avgPace: isCardio && sport === Sport.Running ? formatPace(pace.average) : null,
          avgSpeed: isCardio && sport === Sport.Cycling ? formatSpeed(pace.average) : null,
